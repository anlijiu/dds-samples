...
macro(connextdds_generate_soa_dds_types)
    ...
    connextdds_sanitize_language(LANG ${_SOA_TYPES_LANG} VAR lang_var)

    foreach(file ${_SOA_TYPES_IDL_FILES})
        ...
        # Set unbounded 
        set(unbounded "")
        if(_SOA_TYPES_UNBOUNDED)
            set(unbounded "UNBOUNDED")
        endif()

        set(namespace "")
        if(${_SOA_TYPES_LANG} STREQUAL "C++")
            set(namespace "NAMESPACE")
        endif()

        connextdds_rtiddsgen_run(
            LANG ${_SOA_TYPES_LANG}
            OUTPUT_DIRECTORY "${_SOA_TYPES_OUTPUT_DIRECTORY}/${idl_dir_name}"
            IDL_FILE ${file}
            INCLUDE_DIRS ${_SOA_TYPES_INCLUDE_DIRS}
            ${unbounded}
            ${namespace}
            STL
            VAR generated_file
